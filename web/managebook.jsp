                                    ...
                                    <select class="form-control" id="publisher" name="publisher">
                                        <%
                                            ...
                                            while (rs1.next()) {
                                                ...
                                                String publisher = rs1.getString("name");
                                        %>
                                        <option value="<%=pid%>"><%=publisher%>
                                        </option>
                                        <% } %>
                                    </select>
                                </div>
                        ...
                        <td>
                            ...
                            <div class="btn-group mr-2">
                                <button class="btn btn-sm btn-outline-secondary" data-toggle="modal"
                                        data-target="#editmodal" onclick="editBook(<%=id%>);">修改
                                </button>
                                <button class="btn btn-sm btn-outline-secondary" onclick="deleteBook(<%=id%>);">删除
                                </button>
                            </div>
                        </td>
                    </tr>
